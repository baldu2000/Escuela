...
$notasnoviembre = Notanoviembre::obtenerDeEstudiante($estudiante->id);
$materiasConCalificacion = Notanoviembre::combinar($materias, $notasnoviembre);
?>
<div class="row">
    <div class="col-12">
    ...
    <div class="col-12 table-responsive">
        <table class="table">
            <thead>
                <tr>
                    <th>Notas del mes de Noviembre</th>
                    <th>Puntaje</th>
                </tr>
            </thead>
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <form action="modificar_notanoviembre.php" method="POST" class="form-inline">
