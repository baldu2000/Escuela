...
$notas1 = Nota1::obtenerDeEstudiante($estudiante->id);
$materiasConCalificacion = Nota1::combinar($materias, $notas1);
?>
<div class="row">
    <div class="col-12">
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <form action="modificar_nota1.php" method="POST" class="form-inline">
