...
$notasjunio = Notajunio::obtenerDeEstudiante($estudiante->id);
$materiasConCalificacion = Notajunio::combinar($materias, $notasjunio);
?>
<div class="row">
    <div class="col-12">
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <form action="modificar_notajunio.php" method="POST" class="form-inline">
