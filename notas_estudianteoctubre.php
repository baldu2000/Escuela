...
$notasoctubre = Notaoctubre::obtenerDeEstudiante($estudiante->id);
$materiasConCalificacion = Notaoctubre::combinar($materias, $notasoctubre);
?>
<div class="row">
    <div class="col-12">
    ...
    <div class="col-12 table-responsive">
        <table class="table">
            <thead>
                <tr>
                    <th>Notas del mes de Octubre</th>
                    <th>Puntaje</th>
                </tr>
            </thead>
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <form action="modificar_notaoctubre.php" method="POST" class="form-inline">
