...
$notasseptiembre = Notaseptiembre::obtenerDeEstudiante($estudiante->id);
$materiasConCalificacion = Notaseptiembre::combinar($materias, $notasseptiembre);
?>
<div class="row">
    <div class="col-12">
    ...
    <div class="col-12 table-responsive">
        <table class="table">
            <thead>
                <tr>
                    <th>Notas del mes de Septiembre</th>
                    <th>Puntaje</th>
                </tr>
            </thead>
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <form action="modificar_notaseptiembre.php" method="POST" class="form-inline">
