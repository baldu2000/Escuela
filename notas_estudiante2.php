...
$notas2 = Nota2::obtenerDeEstudiante($estudiante->id);
$materiasConCalificacion = Nota2::combinar($materias, $notas2);
?>
<div class="row">
    <div class="col-12">
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <form action="modificar_nota2.php" method="POST" class="form-inline">
