...
$notas3 = Nota3::obtenerDeEstudiante($estudiante->id);
$materiasConCalificacion = Nota3::combinar($materias, $notas3);
?>
<div class="row">
    <div class="col-12">
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <form action="modificar_nota3.php" method="POST" class="form-inline">
